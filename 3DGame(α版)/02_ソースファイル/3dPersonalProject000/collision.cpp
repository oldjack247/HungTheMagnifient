...
// 戻り値 : 当たったかどうかを返す
//=============================================================================
bool CCollision::RectangleCollision3D(D3DXVECTOR3 pPos1, D3DXVECTOR3 size1,
...
{
	// 距離
	float distance = powf(pos1.x - pos2.x, 2.0f) + powf(pos1.z - pos2.z, 2.0f);
...
//=============================================================================
// [SphereCollision] 円の内側の当たり判定
// pos1     : ぶつかる側の位置
// size1    : ぶつかる側のサイズ
// pos2     : ぶつかられる側の位置
// 戻り値 : ぶつかる側が円の中に入っているかどうか
//=============================================================================
bool CCollision::SphereCollisionInside(D3DXVECTOR3 pos1, float size1, D3DXVECTOR3 pos2)
{
	// 距離
	float distance = sqrtf(powf(pos1.x - pos2.x, 2.0f) + powf(pos1.z - pos2.z, 2.0f));

	// 半径
	float radius = sqrtf(powf(size1, 2.0f));
