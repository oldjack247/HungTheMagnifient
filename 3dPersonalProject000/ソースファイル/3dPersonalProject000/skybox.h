...
// マクロ定義
//=============================================================================
#define MAX_MATERIAL (50) // マテリアルの最大値
#define ADD_ROT (0.0001f) // 角度の加算する量
...
{
public:
	CSkyBox(int nPriority = CScene::OBJTYPE_SKYBOX);//コンストラクタ
	~CSkyBox();//デストラクタ

	static CSkyBox* Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, D3DXVECTOR3 size);//生成処理
