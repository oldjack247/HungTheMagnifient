...
CSound::SOUNDPARAM CSound::m_aParam[SOUND_LABEL_MAX] = // 各音素材のパラメータ
{
	...
	{ "data/SOUND/SE/playerdamage.wav", 0 },	// ダメージ(プレイヤー)
	{ "data/SOUND/SE/zombie_damage.wav", 0 },	// ダメージ(ゾンビ)
	{ "data/SOUND/SE/zombie_death.wav", 0 },	// 死(ゾンビ)
	{ "data/SOUND/SE/enemydamage.wav", 0 },		// 敵を切った時の音
	{ "data/SOUND/SE/fire.wav", 0 },			// 炎の音
	{ "data/SOUND/SE/magic.wav", 0 },			// 魔法の音
	{ "data/SOUND/SE/magiccircle.wav", 0 },		// 魔法陣の音
	{ "data/SOUND/SE/slash.wav", 0 },			// 斬る音
};
